...
class msPrimeSimulate():
    ...
    def main(self):
        ...
        dem14 = msprime.Demography() # 600_200
        dem15 = msprime.Demography() # 1000_200
        dem16 = msprime.Demography() # 1400_200
        ...
        dem14.add_population(name="ThreeEpB_600_200",
            description="Three epoch bottleneck, 600, 200", initial_size=50000)
        dem15.add_population(name="ThreeEpB_1000_200",
            description="Three epoch bottleneck, 1000, 200", initial_size=50000)
        dem16.add_population(name="ThreeEpB_1400_200",
        ...
        #     mts14 = msprime.sim_mutations(ts14, rate=1.5E-8)
        #     mts14.write_vcf(f14)
        #     tree_14 = ts14.first()
        #     with open(coalescent_600_200, "w+") as g14:
        ...
        # with open(branch_length_600_200, "w+") as h14:
        ...
        # with open(output_ThreeEpB_1000_200, "w+") as f15:
        #     ts15 = msprime.sim_ancestry(samples={"ThreeEpB_1000_200": sample_size},
        #         demography=dem15, sequence_length=5000000, recombination_rate=1e-8)
        #     mts15 = msprime.sim_mutations(ts15, rate=1.5E-8)
        #     mts15.write_vcf(f15)
        #     tree_15 = ts15.first()
        #     with open(coalescent_1000_200, "w+") as g15:
        ...
        # with open(branch_length_1000_200, "w+") as h15:
