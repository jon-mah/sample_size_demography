...
alt_sample_size=$((SGE_TASK_ID+1))

# echo $alt_sample_size
...
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/TwoEpochContraction_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/TwoEpochContraction_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/TwoEpochExpansion_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/TwoEpochExpansion_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/ThreeEpochContraction_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/ThreeEpochContraction_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/ThreeEpochExpansion_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/ThreeEpochExpansion_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/ThreeEpochBottleneck_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/ThreeEpochBottleneck_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/tennessen_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/tennessen_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/1000_1000_bottleneck_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/1000_1000_bottleneck_${alt_sample_size}
# python compute_sfs_summary_statistics.py ../Simulations/lynch_theory/2000_2000_bottleneck_${alt_sample_size}_expected_sfs.txt ../Simulations/lynch_theory/2000_2000_bottleneck_${alt_sample_size}
