...
# python fit_demographic_model.py ../Simulations/simple_simulations/ThreeEpochBottleneck_1000_2000_${sample_size}_concat.sfs ../Analysis/msprime_3EpB_1000_2000_${sample_size}/ --model_type two_epoch
...
# python fit_demographic_model.py ../Simulations/simple_simulations/ThreeEpochBottleneck_100_150_${sample_size}_concat.sfs ../Analysis/msprime_3EpB_100_150_${sample_size}/ --model_type two_epoch
 python fit_demographic_model.py ../Simulations/simple_simulations/ThreeEpochBottleneck_100_200_${sample_size}_concat.sfs ../Analysis/msprime_3EpB_100_200_${sample_size}/ --model_type three_epoch
