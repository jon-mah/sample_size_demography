...
do
    ...
    easySFS.py -a -f -i ../Simulations/simple_simulations/ThreeEpochBottleneck_100_200_${sample_size}_${i}.vcf -p sample_${sample_size}_pops.txt -o ../Simulations/simple_simulations/ThreeEpochBottleneck_150_200_${sample_size}_${i} --proj ${sample_size}
