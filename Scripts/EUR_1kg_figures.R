...
EUR_empirical_syn = read_input_sfs('../Data/1KG_2020/syn_chr_concat.sfs')
EUR_empirical_syn_nonsyn = read_input_sfs('../Data/1KG_2020/nonsyn_chr_concat.sfs')

EUR_old_syn_10 = read_input_sfs('../Analysis/1kg_EUR_10/syn_downsampled_sfs.txt')
EUR_old_nonsyn_10 = read_input_sfs('../Analysis/1kg_EUR_10/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_10 = read_input_sfs('../Data/1KG_2020/10_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_10 = read_input_sfs('../Data/1KG_2020/10_nonsyn_downsampled_sfs.txt')
EUR_one_epoch_10 = sfs_from_demography('../Analysis/1kg_EUR_2020_10/one_epoch_demography.txt')
EUR_two_epoch_10 = sfs_from_demography('../Analysis/1kg_EUR_2020_10/two_epoch_demography.txt')
EUR_three_epoch_10 = sfs_from_demography('../Analysis/1kg_EUR_2020_10/three_epoch_demography.txt')
gnomAD_empirical_syn_10 = read_input_sfs('../Analysis/gnomAD_10/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_10 = read_input_sfs('../Analysis/gnomAD_10/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_10 = sfs_from_demography('../Analysis/gnomAD_10/one_epoch_demography.txt')

EUR_old_syn_20 = read_input_sfs('../Analysis/1kg_EUR_20/syn_downsampled_sfs.txt')
EUR_old_nonsyn_20 = read_input_sfs('../Analysis/1kg_EUR_20/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_20 = read_input_sfs('../Data/1KG_2020/20_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_20 = read_input_sfs('../Data/1KG_2020/20_nonsyn_downsampled_sfs.txt')
gnomAD_empirical_syn_20 = read_input_sfs('../Analysis/gnomAD_20/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_20 = read_input_sfs('../Analysis/gnomAD_20/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_20 = sfs_from_demography('../Analysis/gnomAD_20/one_epoch_demography.txt')

EUR_old_syn_30 = read_input_sfs('../Analysis/1kg_EUR_30/syn_downsampled_sfs.txt')
EUR_old_nonsyn_30 = read_input_sfs('../Analysis/1kg_EUR_30/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_30 = read_input_sfs('../Data/1KG_2020/30_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_30 = read_input_sfs('../Data/1KG_2020/30_nonsyn_downsampled_sfs.txt')
gnomAD_empirical_syn_30 = read_input_sfs('../Analysis/gnomAD_30/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_30 = read_input_sfs('../Analysis/gnomAD_30/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_30 = sfs_from_demography('../Analysis/gnomAD_30/one_epoch_demography.txt')

EUR_old_syn_50 = read_input_sfs('../Analysis/1kg_EUR_50/syn_downsampled_sfs.txt')
EUR_old_nonsyn_50 = read_input_sfs('../Analysis/1kg_EUR_50/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_50 = read_input_sfs('../Data/1KG_2020/50_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_50 = read_input_sfs('../Data/1KG_2020/50_nonsyn_downsampled_sfs.txt')
gnomAD_empirical_syn_50 = read_input_sfs('../Analysis/gnomAD_50/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_50 = read_input_sfs('../Analysis/gnomAD_50/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_50 = sfs_from_demography('../Analysis/gnomAD_50/one_epoch_demography.txt')

EUR_old_syn_100 = read_input_sfs('../Analysis/1kg_EUR_100/syn_downsampled_sfs.txt')
EUR_old_nonsyn_100 = read_input_sfs('../Analysis/1kg_EUR_100/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_100 = read_input_sfs('../Data/1KG_2020/100_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_100 = read_input_sfs('../Data/1KG_2020/100_nonsyn_downsampled_sfs.txt')
EUR_one_epoch_100 = sfs_from_demography('../Analysis/1kg_EUR_2020_100/one_epoch_demography.txt')
EUR_two_epoch_100 = sfs_from_demography('../Analysis/1kg_EUR_2020_100/two_epoch_demography.txt')
EUR_three_epoch_100 = sfs_from_demography('../Analysis/1kg_EUR_2020_100/three_epoch_demography.txt')
gnomAD_empirical_syn_100 = read_input_sfs('../Analysis/gnomAD_100/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_100 = read_input_sfs('../Analysis/gnomAD_100/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_100 = sfs_from_demography('../Analysis/gnomAD_100/one_epoch_demography.txt')

EUR_old_syn_150 = read_input_sfs('../Analysis/1kg_EUR_150/syn_downsampled_sfs.txt')
EUR_old_nonsyn_150 = read_input_sfs('../Analysis/1kg_EUR_150/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_150 = read_input_sfs('../Data/1KG_2020/150_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_150 = read_input_sfs('../Data/1KG_2020/150_nonsyn_downsampled_sfs.txt')
gnomAD_empirical_syn_150 = read_input_sfs('../Analysis/gnomAD_150/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_150 = read_input_sfs('../Analysis/gnomAD_150/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_150 = sfs_from_demography('../Analysis/gnomAD_150/one_epoch_demography.txt')

EUR_old_syn_200 = read_input_sfs('../Analysis/1kg_EUR_200/syn_downsampled_sfs.txt')
EUR_old_nonsyn_200 = read_input_sfs('../Analysis/1kg_EUR_200/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_200 = read_input_sfs('../Data/1KG_2020/200_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_200 = read_input_sfs('../Data/1KG_2020/200_nonsyn_downsampled_sfs.txt')
gnomAD_empirical_syn_200 = read_input_sfs('../Analysis/gnomAD_200/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_200 = read_input_sfs('../Analysis/gnomAD_200/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_200 = sfs_from_demography('../Analysis/gnomAD_200/one_epoch_demography.txt')

EUR_old_syn_300 = read_input_sfs('../Analysis/1kg_EUR_300/syn_downsampled_sfs.txt')
EUR_old_nonsyn_300 = read_input_sfs('../Analysis/1kg_EUR_300/nonsyn_downsampled_sfs.txt')
EUR_empirical_syn_300 = read_input_sfs('../Data/1KG_2020/300_syn_downsampled_sfs.txt')
EUR_empirical_nonsyn_300 = read_input_sfs('../Data/1KG_2020/300_nonsyn_downsampled_sfs.txt')
EUR_one_epoch_300 = sfs_from_demography('../Analysis/1kg_EUR_2020_300/one_epoch_demography.txt')
EUR_two_epoch_300 = sfs_from_demography('../Analysis/1kg_EUR_2020_300/two_epoch_demography.txt')
EUR_three_epoch_300 = sfs_from_demography('../Analysis/1kg_EUR_2020_300/three_epoch_demography.txt')
gnomAD_empirical_syn_300 = read_input_sfs('../Analysis/gnomAD_300/syn_downsampled_sfs.txt')
gnomAD_empirical_nonsyn_300 = read_input_sfs('../Analysis/gnomAD_300/nonsyn_downsampled_sfs.txt')
gnomAD_one_epoch_300 = sfs_from_demography('../Analysis/gnomAD_300/one_epoch_demography.txt')

compare_syn_nonsyn_count(EUR_empirical_syn, EUR_empirical_syn_nonsyn) +
  ggtitle('1KG EUR (2020) empirical SFS, up to 20-tons')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_10, EUR_empirical_nonsyn_10, gnomAD_empirical_nonsyn_10) +
  ggtitle('Proportional Nonsynonymous SFS, n=10')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_20, EUR_empirical_nonsyn_20, gnomAD_empirical_nonsyn_20) +
  ggtitle('Proportional Nonsynonymous SFS, n=20')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_30, EUR_empirical_nonsyn_30, gnomAD_empirical_nonsyn_30) +
  ggtitle('Proportional Nonsynonymous SFS, n=30')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_50, EUR_empirical_nonsyn_50, gnomAD_empirical_nonsyn_50) +
  ggtitle('Proportional Nonsynonymous SFS, n=50')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_100, EUR_empirical_nonsyn_100, gnomAD_empirical_nonsyn_100) +
  ggtitle('Proportional Nonsynonymous SFS, n=100')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_150, EUR_empirical_nonsyn_150, gnomAD_empirical_nonsyn_150) +
  ggtitle('Proportional Nonsynonymous SFS, n=150')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_200, EUR_empirical_nonsyn_200, gnomAD_empirical_nonsyn_200) +
  ggtitle('Proportional Nonsynonymous SFS, n=200')

compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_300, EUR_empirical_nonsyn_300, gnomAD_empirical_nonsyn_300) +
  ggtitle('Proportional Nonsynonymous SFS, n=300')

compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_10, 
  EUR_empirical_syn_10, gnomAD_empirical_syn_10, gnomAD_one_epoch_10) + ggtitle('Sample size = 10')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_20,
  EUR_empirical_syn_20, gnomAD_empirical_syn_20, gnomAD_one_epoch_20) + ggtitle('Sample size = 20')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_30,
  EUR_empirical_syn_30, gnomAD_empirical_syn_30, gnomAD_one_epoch_30) + ggtitle('Sample size = 30')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_50,
  EUR_empirical_syn_50, gnomAD_empirical_syn_50, gnomAD_one_epoch_50) + ggtitle('Sample size = 50')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_100,
  EUR_empirical_syn_100, gnomAD_empirical_syn_100, gnomAD_one_epoch_100) + ggtitle('Sample size = 100')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_150,
  EUR_empirical_syn_150, gnomAD_empirical_syn_150, gnomAD_one_epoch_150) + ggtitle('Sample size = 150')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_200,
  EUR_empirical_syn_200, gnomAD_empirical_syn_200, gnomAD_one_epoch_200) + ggtitle('Sample size = 200')
compare_1kg_gnomad_null_proportional_cutoff(EUR_old_syn_300,
  EUR_empirical_syn_300, gnomAD_empirical_syn_300, gnomAD_one_epoch_300) + ggtitle('Sample size = 300')

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_10, EUR_empirical_syn_10, 
  gnomAD_empirical_syn_10) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 10') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_10, 
    EUR_empirical_nonsyn_10, gnomAD_empirical_nonsyn_10) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_20, EUR_empirical_syn_20, 
  gnomAD_empirical_syn_20) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 20') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_20, 
    EUR_empirical_nonsyn_20, gnomAD_empirical_nonsyn_20) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_30, EUR_empirical_syn_30, 
  gnomAD_empirical_syn_30) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 30') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_30, 
    EUR_empirical_nonsyn_30, gnomAD_empirical_nonsyn_30) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_50, EUR_empirical_syn_50, 
  gnomAD_empirical_syn_50) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 50') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_50, 
    EUR_empirical_nonsyn_50, gnomAD_empirical_nonsyn_50) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_100, EUR_empirical_syn_100, 
  gnomAD_empirical_syn_100) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 100') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_100, 
    EUR_empirical_nonsyn_100, gnomAD_empirical_nonsyn_100) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_150, EUR_empirical_syn_150, 
  gnomAD_empirical_syn_150) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 150') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_150, 
    EUR_empirical_nonsyn_150, gnomAD_empirical_nonsyn_150) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_200, EUR_empirical_syn_200, 
  gnomAD_empirical_syn_200) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 200') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_200, 
    EUR_empirical_nonsyn_200, gnomAD_empirical_nonsyn_200) + plot_layout(nrow=2)

compare_1kg_gnomad_syn_proportional_cutoff(EUR_old_syn_300, EUR_empirical_syn_300, 
  gnomAD_empirical_syn_300) + theme(axis.title.x = element_blank()) + ggtitle('Sample size = 300') +
  compare_1kg_gnomad_nonsyn_proportional_cutoff(EUR_old_nonsyn_300, 
    EUR_empirical_nonsyn_300, gnomAD_empirical_nonsyn_300) + plot_layout(nrow=2)

compare_one_two_three_proportional_sfs_cutoff(EUR_empirical_syn_10, EUR_one_epoch_10, 
  EUR_two_epoch_10, EUR_three_epoch_10) +
  ggtitle('1KG EUR 2020, sample size = 10')

compare_one_two_three_proportional_sfs_cutoff(EUR_empirical_syn_100, EUR_one_epoch_100, 
  EUR_two_epoch_100, EUR_three_epoch_100) +
  ggtitle('1KG EUR 2020, sample size = 100')

compare_one_two_three_proportional_sfs_cutoff(EUR_empirical_syn_300, EUR_one_epoch_300, 
  EUR_two_epoch_300, EUR_three_epoch_300) +
  ggtitle('1KG EUR 2020, sample size = 300')
...
for (i in c(10, 100, 300)) {
  subdirectory <- paste0("../Analysis/1kg_EUR_2020_", i)
  empirical_subdirectory <- paste0("../Data/1KG_2020/", i, "_")
  EUR_1kg_empirical_file_path <- paste0(empirical_subdirectory, "syn_downsampled_sfs.txt", sep='')
...
EUR_1kg_df_long$Index <- rep(c(10, 100, 300), times = 3)
...
# Increase the x-axis index by 4
EUR_1kg_df_long_lambda$Index <- rep(c(10, 100, 300), times = 3)
...
# Increase the x-axis index by 4
EUR_1kg_df_long_residual$Index <- rep(c(10, 100, 300), times = 3)

# Create the line plot with ggplot2
ggplot(EUR_1kg_df_long, aes(x = Index, y = AIC, color = Epoch)) +
  geom_line(linetype=3) +
  geom_point() +
  labs(title = "1KG EUR 2020 AIC and residual by sample size",
       x = "Sample Size",
       y = "AIC") +
...
EUR_1kg_one_epoch_NCurr = EUR_1kg_one_epoch_theta / (4 * EUR_1kg_one_epoch_allele_sum * EUR_1kg_mu)
...
max_time = max(EUR_1kg_three_epoch_TimeTotal) + 1
# two_epoch_max_time = max(EUR_1kg_two_epoch_Time)
# three_epoch_max_time = max(EUR_1kg_three_epoch_TimeTotal)

EUR_1kg_one_epoch_max_time = rep(max_time, 3)
EUR_1kg_one_epoch_current_time = rep(0, 3)

EUR_1kg_two_epoch_max_time = rep(max_time, 3)
EUR_1kg_two_epoch_current_time = rep(0, 3)

EUR_1kg_one_epoch_demography = data.frame(EUR_1kg_one_epoch_NAnc, EUR_1kg_one_epoch_max_time,
  EUR_1kg_one_epoch_NCurr, EUR_1kg_one_epoch_current_time)
...
EUR_1kg_three_epoch_max_time = rep(max_time, 3)
EUR_1kg_three_epoch_current_time = rep(0, 3)
...
EUR_1kg_one_epoch_NEffective_10 = c(EUR_1kg_one_epoch_demography[1, 1], EUR_1kg_one_epoch_demography[1, 3])
EUR_1kg_one_epoch_Time_10 = c(-EUR_1kg_one_epoch_demography[1, 2], -EUR_1kg_one_epoch_demography[1, 4])
EUR_1kg_one_epoch_demography_10 = data.frame(EUR_1kg_one_epoch_Time_10, EUR_1kg_one_epoch_NEffective_10)
EUR_1kg_one_epoch_NEffective_100 = c(EUR_1kg_one_epoch_demography[2, 1], EUR_1kg_one_epoch_demography[2, 3])
EUR_1kg_one_epoch_Time_100 = c(-EUR_1kg_one_epoch_demography[2, 2], -EUR_1kg_one_epoch_demography[2, 4])
EUR_1kg_one_epoch_demography_100 = data.frame(EUR_1kg_one_epoch_Time_100, EUR_1kg_one_epoch_NEffective_100)
EUR_1kg_one_epoch_NEffective_300 = c(EUR_1kg_one_epoch_demography[3, 1], EUR_1kg_one_epoch_demography[3, 3])
EUR_1kg_one_epoch_Time_300 = c(-EUR_1kg_one_epoch_demography[3, 2], -EUR_1kg_one_epoch_demography[3, 4])
EUR_1kg_one_epoch_demography_300 = data.frame(EUR_1kg_one_epoch_Time_300, EUR_1kg_one_epoch_NEffective_300)
...
EUR_1kg_two_epoch_NEffective_100 = c(EUR_1kg_two_epoch_demography[2, 1], EUR_1kg_two_epoch_demography[2, 3], EUR_1kg_two_epoch_demography[2, 5])
EUR_1kg_two_epoch_Time_100 = c(-EUR_1kg_two_epoch_demography[2, 2], -EUR_1kg_two_epoch_demography[2, 4], EUR_1kg_two_epoch_demography[2, 6])
EUR_1kg_two_epoch_demography_100 = data.frame(EUR_1kg_two_epoch_Time_100, EUR_1kg_two_epoch_NEffective_100)
EUR_1kg_two_epoch_NEffective_300 = c(EUR_1kg_two_epoch_demography[3, 1], EUR_1kg_two_epoch_demography[3, 3], EUR_1kg_two_epoch_demography[3, 5])
EUR_1kg_two_epoch_Time_300 = c(-EUR_1kg_two_epoch_demography[3, 2], -EUR_1kg_two_epoch_demography[3, 4], EUR_1kg_two_epoch_demography[3, 6])
...
EUR_1kg_three_epoch_NEffective_100 = c(EUR_1kg_three_epoch_demography[2, 1], EUR_1kg_three_epoch_demography[2, 3], EUR_1kg_three_epoch_demography[2, 5], EUR_1kg_three_epoch_demography[2, 7])
EUR_1kg_three_epoch_Time_100 = c(-EUR_1kg_three_epoch_demography[2, 2], -EUR_1kg_three_epoch_demography[2, 4], -EUR_1kg_three_epoch_demography[2, 6], EUR_1kg_three_epoch_demography[2, 8])
EUR_1kg_three_epoch_demography_100 = data.frame(EUR_1kg_three_epoch_Time_100, EUR_1kg_three_epoch_NEffective_100)
EUR_1kg_three_epoch_NEffective_300 = c(EUR_1kg_three_epoch_demography[3, 1], EUR_1kg_three_epoch_demography[3, 3], EUR_1kg_three_epoch_demography[3, 5], EUR_1kg_three_epoch_demography[3, 7])
EUR_1kg_three_epoch_Time_300 = c(-EUR_1kg_three_epoch_demography[3, 2], -EUR_1kg_three_epoch_demography[3, 4], -EUR_1kg_three_epoch_demography[3, 6], EUR_1kg_three_epoch_demography[3, 8])
EUR_1kg_three_epoch_demography_300 = data.frame(EUR_1kg_three_epoch_Time_300, EUR_1kg_three_epoch_NEffective_300)

ggplot(EUR_1kg_three_epoch_demography_10, aes(EUR_1kg_three_epoch_Time_10, EUR_1kg_three_epoch_NEffective_10, color='N=10')) + geom_step(linewidth=1.3, linetype='dotted') +
  geom_step(data=EUR_1kg_three_epoch_demography_100, aes(EUR_1kg_three_epoch_Time_100, EUR_1kg_three_epoch_NEffective_100, color='N=100'), linewidth=1.3, linetype='dotted') +
  geom_step(data=EUR_1kg_three_epoch_demography_300, aes(EUR_1kg_three_epoch_Time_300, EUR_1kg_three_epoch_NEffective_300, color='N=300'), linewidth=1.3, linetype='dotted') +
  scale_color_manual(name='Sample Size',
                     breaks=c('N=10', 'N=100', 'N=300'),
                     values=c('N=10'='#1b9e77',
                       'N=100'='#d95f02',
                       'N=300'='#7570b3'),
                     labels=c('N=10, one-epoch',
                       'N=100, three-epoch',
                       'N=300, three-epoch')) +
  theme_bw() +
  ylab('Effective Population Size') +
  xlab('Time in Years') +
  ggtitle('1KG EUR 2020 best-fit demography')
...
# 
# EUR_empirical_syn_10 = read_input_sfs('../Analysis/1kg_EUR_10/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_20 = read_input_sfs('../Analysis/1kg_EUR_20/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_30 = read_input_sfs('../Analysis/1kg_EUR_30/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_50 = read_input_sfs('../Analysis/1kg_EUR_50/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_100 = read_input_sfs('../Analysis/1kg_EUR_100/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_150 = read_input_sfs('../Analysis/1kg_EUR_150/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_200 = read_input_sfs('../Analysis/1kg_EUR_200/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_300 = read_input_sfs('../Analysis/1kg_EUR_300/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_500 = read_input_sfs('../Analysis/1kg_EUR_500/syn_downsampled_sfs.txt')
...
# 
# EUR_empirical_syn_700 = read_input_sfs('../Analysis/1kg_EUR_700/syn_downsampled_sfs.txt')
